...
\begin{equation}
\Lambda_0 \frac{Z}{Z_0} \left( \frac{T}{T_0} \right)^{\alpha} = \Gamma n^2
\label{eq:thermal_eq}
\end{equation}
...
\begin{equation}
P_{\rm eq} = \frac{k \Lambda_0 Z T_0 T^{\alpha+1}}{\Gamma Z_0}
\label{eq:peq}
\end{equation}
...
Equating these two pressures gives a critical metallicity:
\begin{equation}
Z_{\rm crit} = Z_0 \frac{19.9 c_s^8}{G^3 k \Lambda_0 T_0 T^{1+\alpha}} \frac{\chi \Gamma}{M_{\rm BE}^2}
\label{eq:crit_metal}
\end{equation}
